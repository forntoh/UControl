...
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
    ...
    public TextPrompt(String text, JTextComponent component, Font font) {
        this(text, component, Show.ALWAYS, font);
    }

    public TextPrompt(String text, JTextComponent component, Show show, Font font) {
